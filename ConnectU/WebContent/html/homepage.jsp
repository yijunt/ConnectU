...
<body>
	<header>
		<div class="container">
			...
			<p style="margin-left: 10px; margin-top: 25px; font-size: 15px">Hello, Yi Jun</p>
			</div>
			<nav>
				<ul>
					<!--  <li class="current"><a href="../index.html">Home</a></li>-->
					<li><a style="margin-right: 30px" href="homepage.jsp">Dashboard</a></li>
...
.show {
	...
	<section id="GEheading">
		...
		<body onload="init()">
			<div class="container"
				style="float: left; width: 350px; margin: 25px">
				<div id="GEheading">
					<h2>Free Elective/General Education</h2>

					<button class="button button1">ARTS2603</button>
					<button class="button button2">ARTS2604</button>
					<br> <br>
					<button class="button button3">ARTS1630</button>
					<button class="button button1">ARTS1631</button>
					<br> <br>
			...
			<div id="sample"
				style="width: 60%; float: right; margin: 60px; margin-right: 90px">
				<div id="myDiagramDiv"
					style="background-color: white; border: solid 0px black; width: 100%; height: 550px"></div>
			</div>
