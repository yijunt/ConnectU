...
<section id="GEheading"> <!--Free elective-->
 <body onload="init()">
<div class="container" style="float: left; width:350px; margin: 25px">
	<div id="GEheading">
...
<div id="sample" style="width: 60%;float: right; margin: 60px; margin-right: 90px">
  <div id="myDiagramDiv" style="background-color: white; border: solid 0px black; width: 100%; height: 550px"></div>
</div>
